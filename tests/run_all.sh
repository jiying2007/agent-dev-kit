...
"$SCRIPT_DIR/test_fallback_sunset_matrix.sh"
"$SCRIPT_DIR/test_pilot_readiness.sh"
"$SCRIPT_DIR/test_embedded_production_field_pilot.sh"
"$SCRIPT_DIR/test_embedded_workflow_pilots.sh"
"$SCRIPT_DIR/test_embedded_test_matrix_example.sh"
