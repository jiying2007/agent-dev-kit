"""Canonical ADK matcher with Skill Content v2 eligibility and authority semantics.
...
def _apply_contract(result: Mapping[str, Any], metadata: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    constrained["runtime_role"] = metadata["runtime_role"]
    ...
    constrained["escalation_effects"] = list(escalation_effects)
