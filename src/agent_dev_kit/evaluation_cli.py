"""Evaluation CLI bounded context.

This module owns eval/campaign/repository CLI parsing and delegates evaluation
semantics to the existing typed domain modules. It intentionally keeps the
public cli.py import graph bounded.
"""
