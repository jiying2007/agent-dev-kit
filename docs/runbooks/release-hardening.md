...
```bash
bash scripts/devkit.sh convert --target codex --profile core --extra-profile release-hardening --with-optional-skill adk-incident-rca-report --codex-profile team-collab --out ../reports/adk-codex-handoff --clean
