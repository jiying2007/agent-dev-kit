...
|------|-------------|------|
| 通用开发 | core | 最小核心配置 |
| 个人通用 ADK | personal-core | 精简核心 + 发布 |
...
| 高风险变更 | core + adk-artifact-gating + optional skill | 产物门禁 |

## 叠加规则
- 可叠加: `release-hardening`、`team-core`、`large-refactor` 等 profile 可按任务叠加
- 冲突: release-hardening 与 incident-response/large-refactor 互斥
- 默认: `core`
- 嵌入式推荐: `embedded-fullstack`
